...
public class AbrechnungAbschließenTest extends AbrechnungBasisTest {
    ...
    private IAbrechnung abschließen(IAbrechnung abrechnung) {
        IAbrechnung nächsteAbrechnung = abrechnung.abschließen(umgebung());
    ...
    public IAbrechnung schuldenÜbernahme(IAbrechnung abrechnung,
    ...
    public void checkÜbernahme(IAbrechnung abrechnung, double betrag,
            double zins) {
