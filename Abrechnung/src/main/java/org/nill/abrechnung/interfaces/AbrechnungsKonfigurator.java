...
/**
 * Ein {@link AbrechnungsKonfigurator} erzeugt aufgrund der gebührArt und datenArt
 * die in einer {@link IGebührDefinition} abgelegt sind, {@link GebührFabrik} und
 * {@link GebührRepository}, außerdem erzeugt er einen {@link IGebührBerechnung} 
 * aus der {@link AbrechnungsArt} und der {@link Umgebung} 
 * 
 * @author Thomas Nill
 *
 */
