...
/**
 * Eine {@link GebührenBerechnung} berechnet einen BuchungsAuftrag damit dieser
 * später gebucht werden kann. Dazu kann sie ein {@link GebührRepository} und
 * {@link Gebühr} benutzen.
 * 
 * @author Thomas Nill
 *
 */
public interface IGebührBerechnung {
    ...
    /**
     * Markiert Werte als zu einer {@link IAbrechnung} gehörig und berechnet
     * einen neuen {@link BuchungsAuftrag} aus der {@link IAbrechnung}
     * 
     * @param abrechnung
     * @return
     */
