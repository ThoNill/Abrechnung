...
/**
 * Dieses Interface repräsentiert ein Abrechnung für einen {@link IMandant}
 * für eine Zeitperiode, aktuell innerhalb eines Monat, die getNummer 
 * ermöglich auch feinere Abrechnungen innerhalb eines Monats.
 * 
 * @author javaman
 *
 */
public interface IAbrechnung {
    ...
    /**
     * Abschluß einer {@link IAbrechnung} am Ende des Abrechnungszeitraumes nach Berechnung der Gebühren. 
     * 
     * @param provider
     * @return
     */
    ...
    /**
     * Berechnen der Gebühren mithilfe eines {@link AbrechnungsKonfigurator} in einer
     * {@link Umgebung} 
     * 
     * @param provider
     * @param konfigurator
