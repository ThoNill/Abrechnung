...
/**
 * Nach der Berechnung der Gebühren bleibt auf dem Konto des {@link IMandant}
 * ein Saldo, dieses wird entweder durch eine Buchung in die andere Richtung
 * ausgeglichen.
 * 
 * @author Thomas Nill
 *
...
public class SaldoAusgleichen extends EinBucher {
    ...
    public SaldoAusgleichen(Umgebung umgebung, String textGuthaben,
            String textSchulden) {
        super(umgebung);
