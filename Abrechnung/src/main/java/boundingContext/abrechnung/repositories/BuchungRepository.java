...
public interface BuchungRepository extends CrudRepository<Buchung, Long> {
    ...
    public List<?> getSumBewegungen(@Param("abr") boundingContext.abrechnung.entities.Abrechnung abr);
    ...
    public MonetaryAmount getSumKonto(
            @Param("abr") boundingContext.abrechnung.entities.Abrechnung abr, @Param("art") int art,
    ...
    public MonetaryAmount getSaldo(@Param("abr") boundingContext.abrechnung.entities.Abrechnung abr);
