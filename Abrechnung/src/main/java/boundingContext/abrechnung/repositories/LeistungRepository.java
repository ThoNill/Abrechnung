...
public interface LeistungRepository extends CrudRepository<Leistung, Long> {
    ...
    public MonetaryAmount getBetrag(@Param("abr") boundingContext.abrechnung.entities.Abrechnung abr,
            @Param("art") int art);
    ...
    public Integer markData(@Param("abr") boundingContext.abrechnung.entities.Abrechnung abr,
            @Param("mand") boundingContext.abrechnung.entities.Mandant mand, @Param("art") int art);
